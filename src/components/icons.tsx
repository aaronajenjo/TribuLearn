...
export const Icons = {
  ...
  youtube: (props: SVGProps<SVGSVGElement>) => (
    <svg viewBox="0 0 28 20" fill="none" {...props}>
        <path d="M27.5 3.1s-.3-2.2-1.2-3C25.2.1 24.1 0 22.7 0 18.8 0 14 0 14 0S9.2 0 5.3 0C3.9 0 2.8.1 1.7 1.1.8 1.9.5 3.1.5 3.1S.2 4.6.2 6.2v7.6c0 1.6.3 3.1.3 3.1s.3 2.2 1.2 3c1.1 1 2.4 1.1 3.8 1.1 3.9 0 8.7 0 8.7 0s4.8 0 8.7 0c1.4 0 2.5-.1 3.6-1.1 1-.8 1.2-3 1.2-3s.3-1.5.3-3.1V6.2c0-1.6-.3-3.1-.3-3.1z" fill="#FF0000"></path>
        <path d="M11.2 14.3V5.7l8 4.3-8 4.3z" fill="#fff"></path>
    </svg>
  ),
  sopra: (props: SVGProps<SVGSVGElement>) => (
      <Image src="/sopra_logo.png" alt="Sopra Logo" width={20} height={20} {...props} />
  )
};
